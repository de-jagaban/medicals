 								...
 								<table id="example23" class="display nowrap" cellspacing="0" width="100%">
                                    <thead>
                                        <tr>
                                            ...
                                            <th><?php echo get_phrase('Doctor schedule');?></th>
                                    ...
                                    <?php $get_all_appointments = $this->appointment_model->select_all_appointment();
                                        ...
                                        <tr>
                                                <!-- This is the List appointment table -->
                                            ...
                                            <strong>Start Time: </strong><?php echo $this->db->get_where('schedule', array('schedule_id' => $appointment['schedule_id']))->row()->start_time ;?><br>
                                            <strong>End Time: </strong><?php echo $this->db->get_where('schedule', array('schedule_id' => $appointment['schedule_id']))->row()->end_time ;?><br>
                                            <strong>Per Patient Time: </strong><?php echo $this->db->get_where('schedule', array('schedule_id' => $appointment['schedule_id']))->row()->per_patient_time ;?>
                                            </td>
