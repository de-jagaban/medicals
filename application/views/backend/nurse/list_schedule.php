 								...
 								<table id="example23" class="display nowrap" cellspacing="0" width="100%">
                                    ...
                                    <?php $get_all_schedule = $this->schedule_model->select_schedule(); 
                                        ...
                                        <tr>
                                            ...
                                            <td>
												<a href="#" onclick="confirm_modal('<?php echo base_url();?>nurse/add_schedule/delete/<?php echo $schedule['schedule_id'];?>');">
												<button type="button" class="btn btn-danger btn-circle btn-xs"><i class="fa fa-times"></i> </button>
												</a>

                             					<a href="<?php echo base_url();?>nurse/edit_schedule/<?php echo $schedule['schedule_id'];?>">
