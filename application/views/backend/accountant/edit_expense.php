<div class="row">
	<div class="col-sm-12">
		...
		<div class="panel-heading"> <i class="fa fa-edit"></i>&nbsp;&nbsp;<?php echo get_phrase('Edit Expenses'); ?></div>
                ...
                <?php $select_expense = $this->db->get_where('payment', array('payment_id' => $param2))->result_array();
					...
					array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data'));?>
                    	...
                    	<div class="form-group">
							<button type="submit" class="btn btn-success btn-rounded btn-block btn-sm"> <i class="fa fa-plus"></i>&nbsp;
