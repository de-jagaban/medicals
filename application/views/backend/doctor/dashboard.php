...
<!--row -->
                 ...
                 <div class="col-md-3 col-sm-6">
                        <div class="white-box bg-danger">
                            <div class="r-icon-stats">
                                ...
                                <div class="bodystate">
                                    <h4 style="color:white"><?php echo $this->db->get_where('schedule', array('doctor_id' => $this->session->userdata('doctor_id')))->num_rows();?></h4>
                                    <span class="text-muted"><a href="" style="color:white"><?php echo get_phrase('Total Schedule');?></a></span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="white-box bg-success">
                            <div class="r-icon-stats">
                                <i class="fa fa-book bg-success"></i>
                                <div class="bodystate">
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="white-box bg-info">
                            <div class="r-icon-stats">
                                <i class="fa fa-wheelchair bg-info"></i>
                                <div class="bodystate">
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="white-box bg-purple">
                            <div class="r-icon-stats">
                                <i class="fa fa-user-md bg-purple"></i>
                                <div class="bodystate">
                                <h4 style="color:white"><?php 
                                $doctor_department = $this->db->get_where('doctor', array('doctor_id' => $this->session->userdata('doctor_id')))->row()->department_id;
                ...
                <?php 
                   $doctor_department = $this->db->get_where('doctor', array('doctor_id' => $this->session->userdata('doctor_id')))->row()->department_id; 
                    $sql = "SELECT * FROM patient where department_id='$doctor_department' order by patient_id desc LIMIT 5";
                ...
                <?php 
                    $doctor_department = $this->db->get_where('doctor', array('doctor_id' => $this->session->userdata('doctor_id')))->row()->department_id; 
                    $sql = "SELECT * FROM doctor where department_id='$doctor_department' order by doctor_id desc LIMIT 5";
                    $array_select = $this->db->query($sql)->result_array();
