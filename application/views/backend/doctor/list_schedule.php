			...
			<div class="panel-heading"> <?php echo get_phrase('List Schedules');?></div>
				<div class="panel-body table-responsive">
 								<table id="example23" class="display nowrap" cellspacing="0" width="100%">
                                    ...
                                    <?php $get_all_schedule = $this->db->get_where('schedule', array('doctor_id' => $this->session->userdata('doctor_id')))->result_array();
                                        ...
                                        <tr>
                                            ...
                                            <td>
												<a href="#" onclick="confirm_modal('<?php echo base_url();?>doctor/add_schedule/delete/<?php echo $schedule['schedule_id'];?>');">
												<button type="button" class="btn btn-danger btn-circle btn-xs"><i class="fa fa-times"></i> </button>
												</a>

                             					<a href="<?php echo base_url();?>doctor/edit_schedule/<?php echo $schedule['schedule_id'];?>">
