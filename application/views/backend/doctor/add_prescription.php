		...
		<div class="panel panel-burnt">
			<div class="panel-heading"> <?php echo get_phrase('add_prescription');?>
				...
				<div class="panel-body">
                    ...
                    <?php
                    //This generates a random code which serves as the value for the prescription code
					...
					<div class="form-group">
                        ...
                        <!-- This controls the prescription boxes form -->
                        <div class="form-group">
...
<script type="text/javascript">
 function get_department_patients(department_id){
    ...
    The IDs are connected to the prescription form buttons above using the 'onClick' Method.
-->
    <script type="text/javascript">
