...
<div class="row">
	<div class="col-sm-12">
		<div class="panel panel-burnt">
			...
			<!-- This form controls the submission of the invoice id to the paypal ipn inside the Patient control for payment processing -->
			<form action="https://paystack.com/pay/invoice-pay" method="post" target="_blank">
				<input type="hidden" name="invoice_id" value="<?php echo $row['invoice_id'];?>">
				<button type="submit" class="btn btn-info btn-rounded btn-sm pull-right"><?php echo get_phrase('Pay Now with Paystack');?></button>
			</form>
		
			<form action="<?php echo base_url();?>patient/invoice/pay" method="post" target="_blank">
				<input type="hidden" name="invoice_id" value="<?php echo $row['invoice_id'];?>">
				<button type="submit" class="btn btn-info btn-rounded btn-sm pull-left"><?php echo get_phrase('Pay Now with Paypal');?></button>
			</form>
			<br>
			<hr>
