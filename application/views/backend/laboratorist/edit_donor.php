...
<div class="row">
    ...
    <div class="col-sm-12">
		<div class="panel panel-burnt">
            <div class="panel-heading"> <i class="fa fa-edit"></i>&nbsp;&nbsp;<?php echo get_phrase('Edit donor')?></div>
				<div class="panel-body table-responsive">
        
                    <!----CREATION FORM STARTS---->
                    <?php echo form_open(base_url(). 'donor/manage_donor/update/'. $param2, array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data'));?>  <!-- Opening Form action class -->
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-12">
                                <input name="age" type="text" class="form-control" value="<?php echo $donor_selected_with_id['age'];?>">
                        </div>
                    </div>	
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-12">
                                <input name="phone" type="text" value="<?php echo $donor_selected_with_id['phone'];?>" class="form-control"/ required>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-12">
                                <input name="email" type="text" value="<?php echo $donor_selected_with_id['email'];?>" class="form-control"/ required>
                        </div>
                    </div>
