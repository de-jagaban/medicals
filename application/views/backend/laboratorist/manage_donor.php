		...
		<div class="panel panel-burnt">
            <div class="panel-heading"> <i class="fa fa-plus"></i>&nbsp;&nbsp;<?php echo get_phrase('Add donor')?></div>
				<div class="panel-body table-responsive">
                    ...
                    <?php echo form_open(base_url(). 'donor/manage_donor/create', array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data'));?>  <!-- Opening Form action class -->
                ...
                <div class="panel-body table-responsive">
		            <table id="example23" class="display nowrap" cellspacing="0" width="100%">
                        ...
                        <?php 
                                ...
                                $select_donors = $this->donor_model->select_all_blood_donors(); //Fetches data from the donor database and populates the List donor table with it.
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a onclick="showAjaxModal('<?php echo base_url();?>modal/popup/edit_donor/<?php echo $all_selected_blood_donors['donor_id'];?>')" class="btn btn-success btn-circle btn-xs"><i class="fa fa-edit"></i></a>
                                            <a href="<?php echo base_url();?>donor/manage_donor/delete/<?php echo $all_selected_blood_donors['donor_id'];?>" onclick="return confirm('Are you sure you want to delete');" class="btn btn-danger btn-circle btn-xs" style="color:white"><i class="fa fa-times"></i></a>
