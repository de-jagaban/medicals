		...
		<div class="panel panel-burnt">
            <div class="panel-heading"> <i class="fa fa-plus"></i>&nbsp;&nbsp;<?php echo get_phrase('Add Category'); ?></div>
				<div class="panel-body table-responsive">
                    ...
                    <?php echo form_open(base_url(). 'pharmacist/medicine_category/create', array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data'));?>
                    ...
                    <?php
                            ...
                            foreach ($select_med_categories as $key => $med_category) : ?>
                                    <tr>
                                        ...
                                        <a href="<?php echo base_url();?>pharmacist/medicine_category/delete/<?php echo $med_category['med_category_id'];?>" onclick="return confirm('Are you sure want to delete?');" class="btn btn-danger btn-circle btn-xs" style="color:white"><i class="fa fa-times"></i></a>
