<div class="row">
    ...
    <div class="col-sm-12">
		<div class="panel panel-burnt">
            <div class="panel-heading"> <i class="fa fa-edit"></i>&nbsp;&nbsp;<?php echo get_phrase('Edit Medicine'); ?></div>
                ...
                foreach ($select_medicine as $key => $value) {  ?>
                    <?php echo form_open(base_url(). 'pharmacist/manage_medicine/update/'. $param2, array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data'));?>
