                 ...
                 <div class="col-md-3 col-sm-6">
                        <div class="white-box bg-danger">
                            <div class="r-icon-stats">
                                <i class="fa fa-hospital-o bg-danger"></i>
                                <div class="bodystate">
                    ...
                    <div class="white-box bg-success">
                            <div class="r-icon-stats">
                                <i class="fa fa-medkit bg-success"></i>
                                <div class="bodystate">
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="white-box bg-info">
                            <div class="r-icon-stats">
                                <i class="fa fa-user-md bg-info"></i>
                                <div class="bodystate">
                                    <h4 style="color:white"><?php
                                   
                                    echo $this->db->get('pharmacist')->num_rows();?></h4>
                                    <span class="text-muted"><a href="" style="color:white"><?php echo get_phrase('New Pharmacist');?></a></span>
                                </div>
                            </div>
                        </div>
                    </div>
