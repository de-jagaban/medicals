<div class="row">
		...
		<div class="panel panel-burnt">
            <div class="panel-heading"> <i class="fa fa-plus"></i>&nbsp;&nbsp;<?php echo get_phrase('Add Medicine'); ?></div>
				<div class="panel-body table-responsive">
                    ...
                    <?php echo form_open(base_url(). 'pharmacist/manage_medicine/create', array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data'));?>
                    ...
                    <div class="form-group">
                            <label class="col-md-12" for="example-text"><?php echo get_phrase('Manufacturer'); ?></label>
                        <div class="col-sm-12">
    ...
    <!-- ===== This Controls the List Medicine -->
                    ...
                    <?php
                            ...
                            foreach ($select_all_medicines as $key => $medicine) : ?>
                                    <tr>
                                        ...
                                        <a href="<?php echo base_url();?>pharmacist/manage_medicine/delete/<?php echo $medicine['medicine_id'];?>" onclick="return confirm('Are you sure want to delete?');" class="btn btn-danger btn-circle btn-xs" style="color:white"><i class="fa fa-times"></i></a>
