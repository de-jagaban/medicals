<?php 
$system_name    = $this->db->get_where('settings', array('type' => 'system_name'))->row()->description; //This is fetching the system's details as stored in the database
$system_address = $this->db->get_where('settings', array('type' => 'address'))->row()->description; //This is fetching the system's details as stored in the database
$footer         = $this->db->get_where('settings', array('type' => 'footer'))->row()->description; //This is fetching the system's details as stored in the database
$text_align     = $this->db->get_where('settings', array('type' => 'text_align'))->row()->description; //This is fetching the system's details as stored in the database
...
?>
         ...
         <!-- THE CHAT STYLING ENDS HERE -->



         <!-- THIS IS THE CHAT JS SCRIPT -->
         ...
         <!-- THE CHAT JS SCRIPT ENDS HERE -->



         <!-- THIS IS THE CHAT HTML CODE -->
            ...
            <script language="javascript" src="<?php echo base_url();?>js/optimum-ajax.js"></script>
            <script language="javascript">
                //JS for sending message into the general_message table in the database
        $(function(){
