				...
				<div class="panel-body">
					...
					<div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-12">
                                    <input name="date_created" type="date" id="date" value="<?php echo date('Y-m-d');?>" class="form-control">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-12">
                                    <input name="due_date" type="date" id="date" value="<?php echo date('Y-m-d');?>" class="form-control">
                            </div>
                        </div>
