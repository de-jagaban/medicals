<div class="row">
    <div class="col-sm-12">
        <div class="panel panel-burnt">
            <div class="panel-heading"><?php echo get_phrase('new_general_Service');?>
                <div class="pull-right"><a href="#" data-perform="panel-collapse"><i class="fa fa-plus"></i>&nbsp;&nbsp;ADD NEW GENERAL SERVICE HERE<i class="btn btn-info btn-xs"></i></a> <a href="#" data-perform="panel-dismiss"></a> </div></div>
                    <div class="panel-wrapper collapse out panel-body" aria-expanded="true">          
					    
                        <?php echo form_open(base_url() . 'admin/manage_generalService/create/' , array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data'));?>
                        ...
                        <button type="submit" class="btn btn-success btn-rounded btn-block waves-effect waves-light m-r-10"><i class="fa fa-save"></i>&nbsp;<?php echo get_phrase('save');?></button>
                        <?php echo form_close();?>        
...
<div class="row">
    <div class="col-sm-12">
		<div class="panel panel-burnt">
            <div class="panel-heading"> <i class="fa fa-list"></i>&nbsp;&nbsp;<?php echo get_phrase('list_general_Services');?></div>
                <div class="panel-body table-responsive">
                    <table id="example23" class="display nowrap" cellspacing="0" width="100%">
                        ...
                        <tbody>
                            <!-- This gets the details of generalServices stored in the db through the select_all_generalServices function-->
                        <?php $get_all_generalServices_from_generalService_model = $this->generalService_model->select_all_generalServices();
                                foreach ($get_all_generalServices_from_generalService_model as $key => $selected_generalServices):?>
                            <tr>
                                <td><img src="<?php echo $this->crud_model->get_image_url('generalService', $selected_generalServices['generalService_id']);?>" class="img-circle" width="30px" alt=""></td>
                                <td><?php echo $selected_generalServices['name'];?></td>
                                <td><?php echo $selected_generalServices['email'];?></td>
                                <td><?php echo $selected_generalServices['phone'];?></td>
                                <td><?php echo $selected_generalServices['gender'];?></td>
                                <td><?php echo $selected_generalServices['qualification'];?></td>
                                <td><?php echo $this->crud_model->get_type_name_by_id('department', $selected_generalServices['department_id']);?></td>
                                <td>

                                <a onclick="showAjaxModal('<?php echo base_url();?>modal/popup/edit_generalService/<?php echo $selected_generalServices['generalService_id'];?>')" class="btn btn-success btn-circle btn-xs"><i class="fa fa-edit"></i></a>
                                <a href="<?php echo base_url();?>admin/manage_generalService/delete/<?php echo $selected_generalServices['generalService_id'];?>" onclick="return confirm('Are you sure you want to delete');" class="btn btn-danger btn-circle btn-xs" style="color:white"><i class="fa fa-times"></i></a>
                                <a href="<?php echo base_url() . 'uploads/generalService_image/' . $selected_generalServices['file_name'];?>" class="btn btn-success btn-circle btn-xs"><i class="fa fa-download"></i></a>
                                <a href="<?php echo base_url(). 'admin/completeGeneralServiceProfile/' . $selected_generalServices['generalService_id'];?>" class="btn btn-primary btn-circle btn-xs"><i class="fa fa-link"></i></a>
                                </td>							
                            </tr>
                        <?php endforeach; ?>
                        </tbody>
