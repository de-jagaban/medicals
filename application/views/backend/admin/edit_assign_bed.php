<div class="row">
    ...
    <div class="col-sm-12">
		<div class="panel panel-burnt">
            <div class="panel-heading"> <i class="fa fa-edit"></i>&nbsp;&nbsp;<?php echo get_phrase('Edit Assign Bed'); ?></div>
...
<!-- This JS controls the automatic display of patient name based on a selected department
and the automatic display of the bed details based on a selected bed.

It is controlled by its correspondent functions in the Bed controller.
