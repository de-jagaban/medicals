            ...
            <button class="btn btn-default" type="button"> <i class="fa fa-search"></i> </button>
                    ...
                    ?>
                        ...
                        <ul class="nav nav-second-level">
                            <li><a href="<?php echo base_url();?>admin/change_profile"><i class="ti-user"></i> My Profile</a></li>
                            <li><a href="<?php echo base_url();?>setting/general_settings"><i class="ti-settings"></i> Account Setting</a></li>
                ...
                <li> 
                    ...
                    <ul class="nav nav-second-level"<?php if($page_name == 'manage_department') echo 'active';?>>
                            ...
                            <span class="hide-menu"><?php echo get_phrase('manage_department');?></span>
                            </a> 
                            </li>
                    </ul>
                </li>
                ...
                <li> 
                    ...
                    <ul class="nav nav-second-level"<?php if($page_name == 'manage_doctor') echo 'active';?>>
                            ...
                            <li class="<?php if($page_name == 'manage_pharmacist') echo 'active';?>"> 
                                ...
                                <i class="fa fa-angle-double-right p-r-10"></i>
                                <span class="hide-menu"><?php echo get_phrase('Manage Pharmacist');?></span>
                                </a> 
                            </li>
                            ...
                            <li class="<?php if($page_name == 'manage_laboratorist') echo 'active';?>"> 
                                ...
                                <i class="fa fa-angle-double-right p-r-10"></i>
                                <span class="hide-menu"><?php echo get_phrase('Manage Lab Scientist');?></span>
                                </a> 
                            </li>
                                                 
                            <li class="<?php if($page_name == 'manage_generalService') echo 'active';?>"> 
                                <a href="<?php echo base_url();?>admin/manage_generalService">
                                <i class="fa fa-angle-double-right p-r-10"></i>
                                <span class="hide-menu"><?php echo get_phrase('Manage General Staff');?></span>
                                </a> 
                            </li>
                    </ul>
                </li>
                ...
                <li> 
                    <a href="javascript:void(0);" class="waves-effect"><i class="fa fa-book p-r-10"></i> <span class="hide-menu"> <?php echo get_phrase('Manage Prescription');?> <span class="fa arrow"></span></span></a>
                    <ul class="nav nav-second-level"<?php if($page_name == 'add_prescription' || $page_name == 'list_prescription') echo 'active';?>>
                ...
                <li> 
                    <a href="javascript:void(0);" class="waves-effect"><i class="fa fa-money p-r-10"></i> <span class="hide-menu"> <?php echo get_phrase('Manage Expense');?> <span class="fa arrow"></span></span></a>
                ...
                <li> 
                    ...
                    <ul class="nav nav-second-level"<?php if($page_name == 'general_settings' || $page_name == 'backup_database' || $page_name == 'manage_language' || $page_name == 'about_system') echo 'active';?>>
