            ...
            <div class="panel-heading"> <i class="fa fa-list"></i>&nbsp;&nbsp;<?php echo get_phrase('list_receptionists');?></div>
                <div class="panel-body table-responsive">
                    <table id="example23" class="display nowrap" cellspacing="0" width="100%">
                        ...
                        <tbody>
                            <!-- This gets the details of receptionists stored in the db through the select_all_receptionists function-->
                        <?php $get_all_receptionists_from_receptionist_model = $this->receptionist_model->select_all_receptionists();
                            ...
                            <tr>
                                <td><img src="<?php echo $this->crud_model->get_image_url('receptionist', $selected_receptionists['receptionist_id']);?>" class="img-circle" width="30px" alt=""></td>
                                ...
                                <td><?php echo $this->crud_model->get_type_name_by_id('department', $selected_receptionists['department_id']);?></td>
                                <td>

                                <a onclick="showAjaxModal('<?php echo base_url();?>modal/popup/edit_receptionist/<?php echo $selected_receptionists['receptionist_id'];?>')" class="btn btn-success btn-circle btn-xs"><i class="fa fa-edit"></i></a>
                                <a href="<?php echo base_url();?>admin/manage_receptionist/delete/<?php echo $selected_receptionists['receptionist_id'];?>" onclick="return confirm('Are you sure you want to delete');" class="btn btn-danger btn-circle btn-xs" style="color:white"><i class="fa fa-times"></i></a>
                                <a href="<?php echo base_url() . 'uploads/receptionist_image/' . $selected_receptionists['file_name'];?>" class="btn btn-success btn-circle btn-xs"><i class="fa fa-download"></i></a>
                                <a href="<?php echo base_url(). 'admin/completereceptionistProfile/' . $selected_receptionists['receptionist_id'];?>" class="btn btn-primary btn-circle btn-xs"><i class="fa fa-link"></i></a>
                                </td>							
                            </tr>
                        <?php endforeach; ?>
                        </tbody>
