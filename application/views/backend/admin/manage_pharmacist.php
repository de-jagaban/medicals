<div class="row">
    <div class="col-sm-12">
        <div class="panel panel-burnt">
            <div class="panel-heading"><?php echo get_phrase('new_pharmacist');?>
                <div class="pull-right"><a href="#" data-perform="panel-collapse"><i class="fa fa-plus"></i>&nbsp;&nbsp;ADD NEW PHARMACIST HERE<i class="btn btn-info btn-xs"></i></a> <a href="#" data-perform="panel-dismiss"></a> </div></div>
...
<div class="row">
    <div class="col-sm-12">
		<div class="panel panel-burnt">
            <div class="panel-heading"> <i class="fa fa-list"></i>&nbsp;&nbsp;<?php echo get_phrase('list_pharmacists');?></div>
                <div class="panel-body table-responsive">
                    <table id="example23" class="display nowrap" cellspacing="0" width="100%">
                        ...
                        <tbody>
                            <!-- This gets the details of pharmacists stored in the db through the select_all_pharmacists function-->
                        <?php $get_all_pharmacists_from_pharmacist_model = $this->pharmacist_model->select_all_pharmacists();
                                foreach ($get_all_pharmacists_from_pharmacist_model as $key => $selected_pharmacists):?>
                            <tr>
                                <td><img src="<?php echo $this->crud_model->get_image_url('pharmacist', $selected_pharmacists['pharmacist_id']);?>" class="img-circle" width="30px" alt=""></td>
                                <td><?php echo $selected_pharmacists['name'];?></td>
                                <td><?php echo $selected_pharmacists['email'];?></td>
                                <td><?php echo $selected_pharmacists['phone'];?></td>
                                <td><?php echo $selected_pharmacists['gender'];?></td>
                                <td><?php echo $selected_pharmacists['qualification'];?></td>
                                <td><?php echo $this->crud_model->get_type_name_by_id('department', $selected_pharmacists['department_id']);?></td>
                                <td>

                                <a onclick="showAjaxModal('<?php echo base_url();?>modal/popup/edit_pharmacist/<?php echo $selected_pharmacists['pharmacist_id'];?>')" class="btn btn-success btn-circle btn-xs"><i class="fa fa-edit"></i></a>
                                <a href="<?php echo base_url();?>admin/manage_pharmacist/delete/<?php echo $selected_pharmacists['pharmacist_id'];?>" onclick="return confirm('Are you sure you want to delete');" class="btn btn-danger btn-circle btn-xs" style="color:white"><i class="fa fa-times"></i></a>
                                <a href="<?php echo base_url() . 'uploads/pharmacist_image/' . $selected_pharmacists['file_name'];?>" class="btn btn-success btn-circle btn-xs"><i class="fa fa-download"></i></a>
                                <a href="<?php echo base_url(). 'admin/completepharmacistProfile/' . $selected_pharmacists['pharmacist_id'];?>" class="btn btn-primary btn-circle btn-xs"><i class="fa fa-link"></i></a>
                                </td>							
                            </tr>
                        <?php endforeach; ?>
                        </tbody>
