            ...
            <div class="panel-heading"> <i class="fa fa-list"></i>&nbsp;&nbsp;<?php echo get_phrase('list_nurses');?></div>
                <div class="panel-body table-responsive">
                    <table id="example23" class="display nowrap" cellspacing="0" width="100%">
                        ...
                        <tbody>
                            <!-- This gets the details of nurses stored in the db through the select_all_nurses function-->
                        <?php $get_all_nurses_from_nurse_model = $this->nurse_model->select_all_nurses();
                            ...
                            <tr>
                                <td><img src="<?php echo $this->crud_model->get_image_url('nurse', $selected_nurses['nurse_id']);?>" class="img-circle" width="30px" alt=""></td>
                                ...
                                <a onclick="showAjaxModal('<?php echo base_url();?>modal/popup/edit_nurse/<?php echo $selected_nurses['nurse_id'];?>')" class="btn btn-success btn-circle btn-xs"><i class="fa fa-edit"></i></a>
                                <a href="<?php echo base_url();?>admin/manage_nurse/delete/<?php echo $selected_nurses['nurse_id'];?>" onclick="return confirm('Are you sure you want to delete');" class="btn btn-danger btn-circle btn-xs" style="color:white"><i class="fa fa-times"></i></a>
                                <a href="<?php echo base_url() . 'uploads/nurse_image/' . $selected_nurses['file_name'];?>" class="btn btn-success btn-circle btn-xs"><i class="fa fa-download"></i></a>
                                <a href="<?php echo base_url(). 'admin/completeNurseProfile/' . $selected_nurses['nurse_id'];?>" class="btn btn-primary btn-circle btn-xs"><i class="fa fa-link"></i></a>
                                </td>							
                            </tr>
                        <?php endforeach; ?>
                        </tbody>
