<div class="row">
    <div class="col-lg-12 col-sm-12">
		...
		<div class="panel-body table-responsive">
                    ...
                    <!-- This lists the key phrases based on their phrase_id -->
                    ...
                    ?>
                    	<tr>
                        	<td><?php echo ucwords($field);?></td> <!-- Converts the first letter of the language to Uppercase -->
								<td>
                                <div align="right">
				...
				<?php if (isset($edit_system_phrase)) : ?>
					...
					<?php
                    //This function selects the language phrase for editing/translation.
...
<script>
    //This function ensures that the translate button is...
    //enabled only when a phrase/text is inserted into the box
function enableUpdateButton(id){
	$('#button-'+id).prop('disabled', false); //The button is referenced using the id ="button"
}
