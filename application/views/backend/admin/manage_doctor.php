            ...
            <div class="panel-heading"> <i class="fa fa-list"></i>&nbsp;&nbsp;<?php echo get_phrase('list_doctors');?></div>
                <div class="panel-body table-responsive">
                    <table id="example23" class="display nowrap" cellspacing="0" width="100%">
                        ...
                        <tbody>
                            <!-- This gets the details of doctors stored in the db through the select_all_doctors function-->
                        <?php $get_all_doctors_from_doctor_model = $this->doctor_model->select_all_doctors();
                            ...
                            <tr>
                                <td><img src="<?php echo $this->crud_model->get_image_url('doctor', $selected_doctors['doctor_id']);?>" class="img-circle" width="30px" alt=""></td>
                                ...
                                <a onclick="showAjaxModal('<?php echo base_url();?>modal/popup/edit_doctor/<?php echo $selected_doctors['doctor_id'];?>')" class="btn btn-success btn-circle btn-xs"><i class="fa fa-edit"></i></a>
                                <a href="<?php echo base_url();?>admin/manage_doctor/delete/<?php echo $selected_doctors['doctor_id'];?>" onclick="return confirm('Are you sure you want to delete');" class="btn btn-danger btn-circle btn-xs" style="color:white"><i class="fa fa-times"></i></a>
                                <a href="<?php echo base_url() . 'uploads/doctor_image/' . $selected_doctors['file_name'];?>" class="btn btn-success btn-circle btn-xs"><i class="fa fa-download"></i></a>
                                <a href="<?php echo base_url(). 'admin/completeDoctorProfile/' . $selected_doctors['doctor_id'];?>" class="btn btn-primary btn-circle btn-xs"><i class="fa fa-link"></i></a>
                                </td>							
                            </tr>
                        <?php endforeach; ?>
                        </tbody>
