...
<div class="row">
    <div class="col-sm-12">
        <div class="panel panel-burnt">
            <div class="panel-heading"><?php echo get_phrase('update_doctor');?>
                </div>
                    <div class="panel-body">          
                        ...
                        <?php echo form_open(base_url() . 'admin/manage_doctor/update/' .$param2 , array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data'));?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <input type="text" id="example-text" name="mother_tongue" class="form-control m-r-10" value="<?php echo $all_selected_doctors['mother_tongue'];?>">
                                </div>
                            </div>
                                ...
                                <label class="col-sm-12"><?php echo get_phrase('marital_status');?>*</label>
                                    <div class="col-sm-12">
                                        <select class=" form-control" name="marital_status" data-style="btn-primary btn-outline" required>
                                            ...
                                            <option data-tokens="Married"<?php if($all_selected_doctors['marital_status'] == 'Married') echo 'selected="selected"';?>><?php echo get_phrase('married');?></option>
                                            <option data-tokens="Single"<?php if($all_selected_doctors['marital_status'] == 'Single') echo 'selected="selected"';?>><?php echo get_phrase('single');?></option>
                                            <option data-tokens="Divorced"<?php if($all_selected_doctors['marital_status'] == 'Divorced') echo 'selected="selected"';?>><?php echo get_phrase('divorced');?></option>
                                            <option data-tokens="Engaged"<?php if($all_selected_doctors['marital_status'] == 'Engaged') echo 'selected="selected"';?>><?php echo get_phrase('engaged');?></option>
                                        </select>
                                    </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-12">
                                    <input type="text" id="example-text" name="religion" class="form-control m-r-10" value="<?php echo $all_selected_doctors['religion'];?>" >
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label class="col-md-12"><?php echo get_phrase('biography');?>*</label>
                                    <div class="col-md-12">
                                        <textarea class="form-control" rows="8" name="biography"><?php echo $all_selected_doctors['biography'];?></textarea>
                                    </div>
                                </div>
                                    ...
                                    <div class="white-box">
                                            <h3 class="box-title"><?php echo get_phrase('account_information');?></h3>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-12">
                                                        <input type="text" id="example-phone" name="phone" class="form-control" value="<?php echo $all_selected_doctors['phone'];?>" data-mask="(999) 999-9999">
                                                    </div>
                                                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-12">
                                                    <input type="text" id="example-phone" name="mobile_no" class="form-control" value="<?php echo $all_selected_doctors['mobile_no'];?>" data-mask="(999) 999-9999">
                                                </div>
                                            </div>
