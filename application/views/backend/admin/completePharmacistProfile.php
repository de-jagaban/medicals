	...
	<div class="col-sm-12">
		<div class="panel panel-burnt">
			<div class="panel-heading"> <?php echo get_phrase("pharmacist's_profile");?>
				...
				<a href="<?php echo base_url();?>admin/manage_pharmacist" class="btn btn-orange btn-xs"><i class="fa fa-plus"></i>&nbsp;<?php echo get_phrase('add_pharmacist');?></a>
				...
				<?php echo get_phrase('print');?></button></div>
					<div class="panel-body table-responsive" id="div_print">
						...
						<?php foreach($pharmacist_profile as $row):?>			
            ...
            <!--This echoes out the pharmacists profile details as stored in the database and presents them in a table format -->
				  <tr>
						<td width="180" rowspan="4">
						<img src="<?php echo $this->crud_model->get_image_url('pharmacist',$row['pharmacist_id']);?>" alt="user" class="img-thumbnail img-responsive" 
				  ...
				  <tr>
					<td colspan="3"><div class="alert alert-info">PHARMACIST ACCOUNT INFORMATION</div></td>
				  </tr>
				  <tr>
				 ...
				 <button class="btn btn-sm btn-outline btn-rounded btn-info" type="button" data-toggle="collapse" data-target="#collapseExample1" aria-expanded="false" aria-controls="collapseExample"><?php echo get_phrase ('get_password');?></button>
				  ...
				  <tr>
					<td colspan="3"><div class="alert alert-info">DOWNLOAD FULL DOCUMENTS ABOUT PHARMACIST 
					</div>&nbsp;&nbsp;Download Full Document:&nbsp;<a href="<?php echo base_url().'uploads/pharmacist_image/'.$row['file_name']; ?>">
