				...
				<?php echo form_open(base_url() . 'setting/general_settings/update_setting/' , array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data'));?>
										...
										<!-- This connects to the database and SELECTS and UPDATE the form data with what is in the database  -->
										<div class="form-group">
                                         <label class="col-md-12" for="example-text"><?php echo get_phrase('hospital_name');?>*</span>
                                            <div class="col-md-12">
                                    ...
                                    <label class="col-md-12" for="example-text"><?php echo get_phrase('system_title');?>*</span>
                                        ...
                                        <div class="form-group">
                                    <label class="col-md-12" for="example-text"><?php echo get_phrase('system_short_name');?>*</span>
                                            <div class="col-md-12">
                                                <input type="text" name="abbr" value="<?php echo $this->db->get_where('settings', array('type' => 'abbr'))->row()->description;?>" class="form-control form-control-line">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                          <label class="col-md-12" for="example-text"><?php echo get_phrase('website_url');?>*</span>
                                            <div class="col-md-12">
                                          <input type="text" name="website_url" value="<?php echo $this->db->get_where('settings', array('type' => 'website_url'))->row()->description;?>" class="form-control form-control-line">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <label class="col-md-12" for="example-text"><?php echo get_phrase('paystack_email');?>*</span>
                                            <div class="col-md-12">
                                          <input type="text" name="paystack_email" value="<?php echo $this->db->get_where('settings', array('type' => 'paystack_email'))->row()->description;?>" class="form-control form-control-line">
                                            </div>
                                        </div>

                                        <div class="form-group">
                                            <label class="col-md-12" for="example-text"><?php echo get_phrase('test_secret_key');?>*</span>
                                            <div class="col-md-12">
                                          <input type="password" name="test_secret_key" value="<?php echo $this->db->get_where('settings', array('type' => 'test_secret_key'))->row()->description;?>" class="form-control form-control-line">
                                            </div>
                                        </div>

                                        <div class="form-group">
                                            <label class="col-md-12" for="example-text"><?php echo get_phrase('test_public_key');?>*</span>
                                            <div class="col-md-12">
                                          <input type="text" name="test_public_key" value="<?php echo $this->db->get_where('settings', array('type' => 'test_public_key'))->row()->description;?>" class="form-control form-control-line">
                                            </div>
                                        </div>

                                        <div class="form-group">
                                            <label class="col-md-12" for="example-text"><?php echo get_phrase('live_secret_key');?>*</span>
                                            <div class="col-md-12">
                                          <input type="password" name="live_secret_key" value="<?php echo $this->db->get_where('settings', array('type' => 'live_secret_key'))->row()->description;?>" class="form-control form-control-line">
                                            </div>
                                        </div>

                                        <div class="form-group">
                                            <label class="col-md-12" for="example-text"><?php echo get_phrase('live_public_key');?>*</span>
                                            <div class="col-md-12">
                                          <input type="text" name="live_public_key" value="<?php echo $this->db->get_where('settings', array('type' => 'live_public_key'))->row()->description;?>" class="form-control form-control-line">
                                            </div>
                                        </div>

                                        <div class="form-group">
                                            <label class="col-md-12" for="example-text"><?php echo get_phrase('Api Mode');?>*</span>
                                            <div class="col-md-12">

                                            <?php $api_mode = $this->db->get_where('settings', array('type' => 'api_mode'))->row()->description;?>

                                            <select class="form-control" name="api_mode">
                                                <option value="TEST"<?php if($api_mode == 'TEST') echo 'selected="selected"';?>>TEST</option>
                                        ...
                                        <div class="form-group">
                                            <label class="col-md-12" for="example-text"><?php echo get_phrase('Text Align');?>*</span>
                                            <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="currency">                                        
                                                ...
                                                <option value="GBP"<?php if($currency == 'GBP') echo 'selected="selected"';?>>GBP - British Pound Sterling - £</option>                                    
                                                <option value="EUR"<?php if($currency == 'EUR') echo 'selected="selected"';?>>EUR - Euro - €</option>                                                
                                                <option value="NGN"<?php if($currency == 'NGN') echo 'selected="selected"';?> selected>NGN - Nigerian Naira - ₦</option>                                                
                                                <option value="USD"<?php if($currency == 'USD') echo 'selected="selected"';?>>USD - US Dollar - $</option>                                            
                                            </select>                      
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <label class="col-md-12" for="example-text"><?php echo get_phrase('System language');?>*</span>
                                            <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                    <label class="col-md-12" for="example-text"><?php echo get_phrase('hospital_address');?>*</span>
                                    <div class="col-md-12">
								...
								<!--  GENERAL SETTINGS UPDATE FORM CLOSES HERE -->
...
<?php echo form_open(base_url() . 'setting/general_settings/upload_logo/' , array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data'));?>	
                    ...
                    <div class="form-group">
                        <div class="col-sm-12">
                            <button class="btn btn-success btn-block btn-rounded btn-sm"><i class="fa fa-save"></i> <?php echo get_phrase('save');?></button>
                        </div>
                    </div>	
                    <?php echo form_close();?>


                    <!-- THIS CONTROLS THE THEME SETTINGS -->
        ...
        ?>
                ...
                <div class="form-group">
                          <button type="submit" class="btn btn-block btn-success btn-rounded btn-sm"><i class="fa fa-plus"></i>&nbsp;<?php echo get_phrase('change_theme');?></button>
                    </div>
                    <?php echo form_close();?>	

                                    <!--SETTINGS UPDATE FORM FOR LOGO CLOSES HERE -->
