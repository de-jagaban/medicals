                        	...
                        	<td><?php echo get_phrase($type);?></td>
								<td>
									<div align="right">
										...
										<button type="button" class="btn btn-danger btn-circle btn-xs"><i class="fa fa-times" onclick="return confirm('Are you sure you want to Delete Database ?');"></i>
										</button></a></div>
									</div>
								</td>
                       	 	</tr>
