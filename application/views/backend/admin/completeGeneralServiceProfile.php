<div class="row">
	<div class="col-sm-12">
		<div class="panel panel-burnt">
			<div class="panel-heading"> <?php echo get_phrase("general_Service's_profile");?>
							
				<a href="<?php echo base_url();?>admin/manage_generalService" class="btn btn-orange btn-xs"><i class="fa fa-plus"></i>&nbsp;<?php echo get_phrase('add_generalService');?></a>
				...
				<?php echo get_phrase('print');?></button></div>
					<div class="panel-body table-responsive" id="div_print">
						...
						<?php foreach($generalService_profile as $row):?>			
				
						<table class="table" width="1030" border="1">

                        <!-- This echoes out the System Details from the database as the header of the profile document page -->
            ...
            <!--This echoes out the generalServices profile details as stored in the database and presents them in a table format -->
				  <tr>
						<td width="180" rowspan="4">
						<img src="<?php echo $this->crud_model->get_image_url('generalService',$row['generalService_id']);?>" alt="user" class="img-thumbnail img-responsive" 
				  ...
				  <tr>
					...
					<td colspan="2">&nbsp;&nbsp;<?php echo date('d M Y', $row ['date_of_birth']); ?></td>
				  </tr>
				  ...
				  <tr>
					<td colspan="3"><div class="alert alert-info">GENERAL SERVICE ACCOUNT INFORMATION</div></td>
				  </tr>
				  <tr>
				 ...
				 <button class="btn btn-sm btn-outline btn-rounded btn-info" type="button" data-toggle="collapse" data-target="#collapseExample1" aria-expanded="false" aria-controls="collapseExample"><?php echo get_phrase ('get_password');?></button>
				  ...
				  <tr>
					<td colspan="3"><div class="alert alert-info">DOWNLOAD FULL DOCUMENTS ABOUT GENERAL SERVICE 
					</div>&nbsp;&nbsp;Download Full Document:&nbsp;<a href="<?php echo base_url().'uploads/generalService_image/'.$row['file_name']; ?>">
