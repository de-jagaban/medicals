            ...
            <div class="panel-heading"> <i class="fa fa-list"></i>&nbsp;&nbsp;<?php echo get_phrase('list_laboratorists');?></div>
                <div class="panel-body table-responsive">
                    <table id="example23" class="display nowrap" cellspacing="0" width="100%">
                        ...
                        <tbody>
                            <!-- This gets the details of laboratorists stored in the db through the select_all_laboratorists function-->
                        <?php $get_all_laboratorists_from_laboratorist_model = $this->laboratorist_model->select_all_laboratorists();
                            ...
                            <tr>
                                <td><img src="<?php echo $this->crud_model->get_image_url('laboratorist', $selected_laboratorists['laboratorist_id']);?>" class="img-circle" width="30px" alt=""></td>
                                ...
                                <td><?php echo $this->crud_model->get_type_name_by_id('department', $selected_laboratorists['department_id']);?></td>
                                <td>

                                <a onclick="showAjaxModal('<?php echo base_url();?>modal/popup/edit_laboratorist/<?php echo $selected_laboratorists['laboratorist_id'];?>')" class="btn btn-success btn-circle btn-xs"><i class="fa fa-edit"></i></a>
                                <a href="<?php echo base_url();?>admin/manage_laboratorist/delete/<?php echo $selected_laboratorists['laboratorist_id'];?>" onclick="return confirm('Are you sure you want to delete');" class="btn btn-danger btn-circle btn-xs" style="color:white"><i class="fa fa-times"></i></a>
                                <a href="<?php echo base_url() . 'uploads/laboratorist_image/' . $selected_laboratorists['file_name'];?>" class="btn btn-success btn-circle btn-xs"><i class="fa fa-download"></i></a>
                                <a href="<?php echo base_url(). 'admin/completeLaboratoristProfile/' . $selected_laboratorists['laboratorist_id'];?>" class="btn btn-primary btn-circle btn-xs"><i class="fa fa-link"></i></a>
                                </td>							
                            </tr>
                        <?php endforeach; ?>
                        </tbody>
