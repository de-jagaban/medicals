<div class="row">
    ...
    <script type="text/javascript">
        //This SCRIPT function controls the display_doctor_patient_edit in the receptionist Controller
    ...
    function get_doctor_patient_edit(department_id, appointment_id){
        $.ajax({
            url: '<?php echo base_url();?>receptionist/get_doctor_patient_edit/' + department_id + '/' + appointment_id,
    ...
    function get_doctor_schedule(doctor_id){
        $.ajax({
            url: '<?php echo base_url();?>receptionist/get_doctor_schedule/' + doctor_id,
            success: function(response){
