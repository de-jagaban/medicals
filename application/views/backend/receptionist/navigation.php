            ...
            <button class="btn btn-default" type="button"> <i class="fa fa-search"></i> </button>
                    ...
                    ?>
                        ...
                        <ul class="nav nav-second-level">
                            <li><a href="<?php echo base_url();?>receptionist/change_profile"><i class="ti-user"></i> My Profile</a></li>
                ...
                <li> 
                    <a href="javascript:void(0);" class="waves-effect"><i class="fa fa-clock-o p-r-10"></i> <span class="hide-menu"> <?php echo get_phrase('Manage Schedule');?> <span class="fa arrow"></span></span></a>
