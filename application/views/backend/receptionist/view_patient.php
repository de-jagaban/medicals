        ...
        <div class="panel panel-burnt">
            <div class="panel-heading"> <?php echo get_phrase("patient's_profile");?>
					...
					<a href="<?php echo base_url();?>patient/list_patient" 
                     class="btn btn-orange btn-xs" title="<?php echo get_phrase('Click to go back');?>"><i class="fa fa-mail-reply-all"></i>&nbsp;<?php echo get_phrase('back');?>
                    </a>
                    ...
                    <?php foreach($select_patient as $patient => $row):?>		
                        <table class="table" width="1030" border="1">
                            ...
                            <tr>
                                <td colspan="3"><div class="alert alert-info">PATIENT ACCOUNT INFORMATION</div></td>
                            </tr>
                            <tr>
