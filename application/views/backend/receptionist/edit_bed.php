<div class="row">
    ...
    <div class="col-sm-12">
		<div class="panel panel-burnt">
            <div class="panel-heading"> <i class="fa fa-edit"></i>&nbsp;&nbsp;<?php echo get_phrase('Edit Bed')?></div>
                ...
                <?php $get_beds = $this->db->get_where('bed', array('bed_id'=> $param2))->result_array();
                    ...
                    <?php echo form_open(base_url(). 'bed/manage_bed/update/'.$param2, array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data'));?>  <!-- Opening Form action class -->
