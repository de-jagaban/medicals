		...
		<div class="panel panel-burnt">
            <div class="panel-heading"> <i class="fa fa-plus"></i>&nbsp;&nbsp;<?php echo get_phrase('Add bed')?></div>
				<div class="panel-body table-responsive">
                    ...
                    <?php echo form_open(base_url(). 'bed/manage_bed/create', array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data'));?>  <!-- Opening Form action class -->
                ...
                <div class="panel-body table-responsive">
		            <table id="example23" class="display nowrap" cellspacing="0" width="100%">
                        ...
                        <?php 
                                ...
                                $beds = $this->bed_model->select_all_beds(); //Fetches data from the bed database and populates the List bed table with it.
                                    ...
                                    <td><?php echo $this->crud_model->get_type_name_by_id('bed_ward', $bed['bed_ward_id']);?></td>
                                        ...
                                        <td><?php echo $this->db->get_where('settings', array('type' => 'currency'))->row()->description;?> <?php echo number_format($bed['bed_price'],2);?><?php echo get_phrase(' Per day');?></td>
                                        <td>
                                        ...
                                        <td>
                                            ...
                                            <a onclick="showAjaxModal('<?php echo base_url();?>modal/popup/edit_bed/<?php echo $bed['bed_id'];?>')" class="btn btn-success btn-circle btn-xs"><i class="fa fa-edit"></i></a>
                                            <a href="<?php echo base_url();?>bed/manage_bed/delete/<?php echo $bed['bed_id'];?>" onclick="return confirm('Are you sure you want to delete');" class="btn btn-danger btn-circle btn-xs" style="color:white"><i class="fa fa-times"></i></a>
