...
class Payment extends CI_Controller { 
    ...
    function add_invoice ($param1 = null, $param2 = null, $param3 = null){
        ...
        if($param1 == 'create'){
             ...
             $this->session->set_flashdata('flash_message', get_phrase('Invoice Created Successfully'));
         ...
         if($param1 == 'update'){
            ...
            $this->payment_model->updatePaymentTable($param2);
             $this->session->set_flashdata('flash_message', get_phrase('Invoice Updated Successfully'));
             redirect(base_url() . 'payment/list_invoice', 'refresh');
         }
         ...
         if($param1 == 'delete'){
            ...
            $this->payment_model->deleteFromPaymentTable($param2);
             $this->session->set_flashdata('flash_message', get_phrase('Invoice Deleted Successfully'));
             redirect(base_url() . 'payment/list_invoice', 'refresh');
         }
    ...
    function expense_category ($param1 = null, $param2 = null, $param3 = null){
        ...
        if($param1 == 'create'){
             ...
             $this->session->set_flashdata('flash_message', get_phrase('Category Added Successfully'));
         ...
         if($param1 == 'update'){
            ...
            $this->payment_model->updateExpenseCategory($param2);
             $this->session->set_flashdata('flash_message', get_phrase('Category Updated Successfully'));
             redirect(base_url() . 'payment/expense_category', 'refresh');
         }
         ...
         if($param1 == 'delete'){
            ...
            $this->payment_model->deleteExpenseCategory($param2);
             $this->session->set_flashdata('flash_message', get_phrase('Category Deleted Successfully'));
             redirect(base_url() . 'payment/expense_category', 'refresh');
         }
    ...
    function new_expense ($param1 = null, $param2 = null, $param3 = null){
        ...
        if($param1 == 'create'){
             ...
             $this->session->set_flashdata('flash_message', get_phrase('New Expense Saved Successfully'));
         ...
         if($param1 == 'update'){
            ...
            $this->payment_model->updateExpensePayment($param2);
             $this->session->set_flashdata('flash_message', get_phrase('Expense Updated Successfully'));
             redirect(base_url() . 'payment/new_expense', 'refresh');
         }
         ...
         if($param1 == 'delete'){
            ...
            $this->payment_model->deleteExpensePayment($param2);
             $this->session->set_flashdata('flash_message', get_phrase('Expense Deleted Successfully'));
             redirect(base_url() . 'payment/new_expense', 'refresh');
         }
