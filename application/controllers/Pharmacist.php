...
class Pharmacist extends CI_Controller {
    ...
    public function index() {
        if($this->session->userdata('pharmacist_login') != 1) redirect(base_url(). 'login', 'refresh');
    ...
    function dashboard() {
        ...
        $page_data['page_title'] =  get_phrase('pharmacist Dashboard');
        $this->load->view('backend/index', $page_data);
    }


     //******** The function below update pharmacist profile  *****************/
     function change_profile($param1 = null, $param2 = null, $param3 = null){
        if($param1 == 'update_info'){
            $this->pharmacist_model->updatePharmacistInfoFunction();
            $this->session->set_flashdata('flash_message', get_phrase('Data Updated Successfully'));
            redirect(base_url() . 'pharmacist/change_profile', 'refresh');
        }
        if($param1 == 'change_password'){
            $this->pharmacist_model->changePasswordFunction();
    ...
    function medicine_category ($param1 = null, $param2 = null, $param3 = null){
        ...
        if($param1 == 'create'){
            ...
            redirect(base_url() . 'pharmacist/medicine_category', 'refresh');
        }
    ...
    function manage_medicine ($param1 = null, $param2 = null, $param3 = null){
        ...
        if($param1 == 'create'){
            ...
            $this->session->set_flashdata('flash_message', get_phrase('Data Saved Successfully'));
            redirect(base_url() . 'pharmacist/manage_medicine', 'refresh');
        }
