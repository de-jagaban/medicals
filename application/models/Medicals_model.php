...
class Medicals_model extends CI_Model { 
    ...
    function insertIntoIntoMedicalsTable(){
    ...
    function updatePrescriptionTable($param2){
        ...
        //This controls the prescription entries and stores the values into prescription_entries table in the database.
        $prescription_entries = array();
        $diagnose = $this->input->post('entry_diagnose');
        $medicine_name = $this->input->post('entry_medicine_name');
        $medicine_type = $this->input->post('entry_medicine_type');
        ...
        $page_data['prescription_entries'] = json_encode($prescription_entries); //The json_encode encrypts the entries
